...
const CommonApplianceActive5min1: NextPage = () => {
  return (
    <div className="w-full relative rounded-6xl bg-ghostwhite overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[117px] box-border gap-2.5 leading-[normal] tracking-[normal]">
      <FrameComponent
        showBadge
...
export default CommonApplianceActive5min1;
